...
def _build_chat_system_prompt() -> str:
    ...
    return (
        ...
        "Charts: When the user asks for a chart, graph, or visual "
        "(e.g. 'bar chart of top 5 services', 'line chart of costs over time'), "
        "you MUST call the create_chart tool with the data—do not "
        "only describe the chart in text or show a table. "
        "Fetch the data with cost-explorer or other "
